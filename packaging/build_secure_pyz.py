...
- Dianji FT-ALL uses a format registry to detect verified PowerTECH .xls text, PowerTECH .xlsx Datalog, and STS8203 .csv sources, then dispatches to the matching parser module.
